...
### Assessing Normality of Rating

Construct a Quantile-Quantile Plot (QQ Plot) to evaluate the normality of the data. Remember for two independent groups, you must look at the QQ Plot split (|) by the group.  
