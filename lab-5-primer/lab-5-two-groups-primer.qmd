...
- **Cumulative Frequency:** Identify if the cumulative frequency of the data/residuals increases at the same rate  as the normal distribution (as represented by the 1:1 line).   
