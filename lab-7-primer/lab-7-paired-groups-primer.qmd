...
```{r}
#| label: boxplot-age
#| fig-cap: "Distribution of age differences (father minus mother) among 50 birth records from 2022."
#| fig-alt: "Horizontal boxplot of the difference in ages (Father minus Mother) for a sample of 50 births in 2022. The distribution is slightly right-skewed with a median around 2-3 years, indicating fathers tend to be older than mothers."
...
```{r}
#| label: qqplot-bias
#| fig-cap: "QQ plot of father-minus-mother age differences, used to assess normality."
#| fig-alt: "QQ plot of the differences in ages between fathers and mothers at birth. Points generally follow the 1:1 quantile line with some deviation in the upper tail, suggesting approximate normality with a slight right skew."
