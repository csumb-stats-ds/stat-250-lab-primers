...
##### Based on the provided infromation, do we meet the necessary conditions to conduct inference using the t-distribution (e.g. confidence inteval, hypothesis test)?  
...
##### Which of the following would be plausible esimtates for the difference between two true mean ratings?
```{r}
#| label: ci-plausible
#| echo: false
