...
knitr::kable(df_stats(Rating ~ Sex, data = bias), 
             ...
             digits = 2,
             format = "html",
             caption = "Summary statistics for professor ratings by sex of professor depicted in video.")
```

#### Data Visualization
```{r}
#| label: boxplot-bias
#| fig-cap: "Professor ratings by sex of professor depicted in video."
...
```{r}
#| label: qqplot-bias
#| fig-cap: "QQ plots of professor ratings by sex, used to assess normality."
...
:::{.callout-note collapse="true" aria-label="Full evaluation of strength of evidence template"}
