...
## Under Construction - Return 12/6 for an updated version
...
In 1974 a Statistics professor collected data on 592 students at the University of Delware to help the students learn about analysis of categorical data. Import the data `eye-hair-color.csv`.
...
gf_props(~Eye | Hair, data = eye_hair,
         ...
         xlab = "Color of Eyes",
         ylab = "Proportion of Statistics Students at Univ. of Del. in 1974") |> 
  gf_refine(scale_fill_manual(values = c("blue", "brown", "green", "tan")))
```
...
Adjust the code below to calculate the correct p-value for the test.  
