...
You can modify the code above to hide the output if you want.
...
#| label: generalize
#| echo: false
check_question(answer = "Pennies from a bank are a natural random sample from all US Pennies.", 
               options = c("Pennies from a bank are a natural random sample from all US Pennies.", 
