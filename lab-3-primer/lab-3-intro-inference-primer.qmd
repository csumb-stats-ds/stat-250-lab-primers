  ...
  live-html:
    webr:
      packages: 
        ...
        - tidyverse
      repos:
        - https://projectmosaic.r-universe.devs        
      resources: 
...
#### Describe the shape of the distribution of penny ages in our sample.

```{r}
#| label: shape
#| echo: false
check_question(answer = c("Unimodal", 
                          "Skewed Right"),
               options = c("Symmetric",
                           "Skewed Right",
                           "Skewed Left",
...
#| label: population
#| echo: false
check_question(answer = "all circulating US pennies", 
               options = c("all coins", 
                           "all US coins", 
...
#| label: lower-bound
#| echo: false
check_question(answer = c(15.3840), right = "correct", wrong = "not correct")
```
...
#| echo: false
check_question(c("Based on our sample", 
...
#### What needs to be true in order to generalize to the population of interest? 
<!-- Why or why not? If so, explain why. If not, explain why and, if applicable, the population that could be generalized to. -->

```{r}
#| label: generalize
#| echo: false
check_question(answer = "Pennies from a bank are a natural random sample from all circulating US Pennies.", 
               options = c("Pennies from a bank are a natural random sample from all circulating US Pennies.", 
                           "The sample size is greater than 30.", 
                           "The data are symmetric and unimodal."), type = "checkbox")
```
<br>



#### To use the model (t-distribution) to calculate the confidence interval, a condition/conditions need to be satisfied. Which condition(s) are they?  
