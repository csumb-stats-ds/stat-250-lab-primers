...
Use `gf_histogram()` to create a histogram of the sample distribution, being sure to label axes appropriately. Replace the underscored components. 
...
- Go to: [Applet(http://www.rossmanchance.com/applets/2021/tbia/TBIA.html)  
