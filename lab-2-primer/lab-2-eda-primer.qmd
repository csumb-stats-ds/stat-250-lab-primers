...
:::
::: {.g-col-6}
# Header Size 1 {.unlisted .unnumbered}
:::
:::
::: {.grid}
::: {.g-col-6}
...
## R Code: Exploratory Data Analysis for Single Numeric Variables
...
## Help Understanding the Basal Metabolic Rate for Bivalves

In the first question you are given the abstract from the following paper:   

[Metabolic rates, climate and macroevolution: a case study using Neogene molluscs](https://royalsocietypublishing.org/doi/10.1098/rspb.2018.1292)
