...
::: {.callout-note collapse="true" aria-label="Hint: extracting just R-squared in R"}
## Extracting Just $R^2$
...
::: {.callout-note collapse="true" aria-label="Hint: using R to make predictions with predict()"}
